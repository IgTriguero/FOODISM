...
class DataProvider with ChangeNotifier {
  ...
  List<Map<String,dynamic>> restaurants = [
    ...
    {'id': 5, 'name': 'La Tagliatela', 'slogan': 'Forno di Pietra', 'rating': '99%', 'tiempo': '21min'},
    {'id': 6, 'name': 'Fosters Hollywood', 'slogan': 'Tu restaurante de comida americana', 'rating': '95%', 'tiempo': '2min'},
    {'id': 7, 'name': 'Five guys', 'slogan': 'Hamborguesas con Rock & Roll', 'rating': '98%', 'tiempo': '10min'},
    {'id': 8, 'name': 'SushiYa', 'slogan': 'Tu suhsi favorito en un ya!', 'rating': '83%', 'tiempo': '8min'}
  ];
  List<Map<String,dynamic>> chefs = [
    ...
    {'id': 4, 'name': 'JulianDiosSupremo', 'rating': '100%', 'tiempo': '11min', 'restaurante': 5},
    {'id': 5, 'name': 'Kekolokao', 'rating': '50%', 'tiempo': '19min', 'restaurante': 0},
    {'id': 6, 'name': 'Migurl', 'rating': '78%', 'tiempo': '23min', 'restaurante': 6},
    {'id': 7, 'name': 'JulianPutoDios', 'rating': '100%', 'tiempo': '11min', 'restaurante': 7},
    {'id': 8, 'name': 'Heung Min Son', 'rating': '93%', 'tiempo': '13min', 'restaurante': 8}
  ];
